...
export default function AddIncidentDialog({ patientId, reportedById }: AddIncidentDialogProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger render={<Button variant="destructive" size="sm" className="gap-1 bg-destructive hover:bg-destructive/95 text-destructive-foreground" />}>
      ...
      <DialogContent className="sm:max-w-[450px] bg-card border border-border/40 shadow-2xl rounded-2xl">
        <DialogHeader>
          ...
          <DialogDescription>
            Déclarez une anomalie, une chute, ou un problème médical urgent constaté.
          </DialogDescription>
        </DialogHeader>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 pt-3">
          <div className="space-y-2">
            ...
            <Input
              id="title"
              placeholder="Ex: Chute dans la salle de bain / Hausse de tension"
              value={title}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              id="description"
              placeholder="Décrivez précisément les faits, l'heure et l'état actuel du patient..."
              value={description}
